- Capture the flag: 2021 CTF Hacking: What is Capture the Flag in Security? | AT&T Cybersecurity and Google CTF (capturetheflag.withgoogle.com) see how it’s done exactly to leverage in the project.
